    ...
    <section id="about" className="py-20 bg-neutral-50 dark:bg-neutral-900/50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <p className="mb-4">
              I'm an AI Automation Expert and Co-founder at <strong>Zaktomate</strong>, an AI automation agency helping businesses and individuals automate parts or entire workflows. My focus is on architecting end-to-end automation systems that deliver measurable efficiency gains.
            </p>
            <p>
