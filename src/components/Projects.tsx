          ...
          {projects.map((project, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-sm border border-neutral-200 dark:border-neutral-700 flex flex-col group transition-shadow duration-300 min-w-0 ${!project.private ? 'cursor-pointer hover:shadow-md' : ''} ${isExpanded ? 'z-20' : 'z-10'} min-h-[450px]`}
              >
                <div className="mb-4">
                ...
                <div className="pt-4 border-t border-neutral-100 dark:border-neutral-700 flex items-center gap-4">
                  {project.github && (
